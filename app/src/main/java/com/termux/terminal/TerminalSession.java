...
public final class TerminalSession extends TerminalOutput {
    ...
    private final boolean mExternalSession;
    private final TerminalSessionOutput mExternalOutput;
    ...
    public TerminalSession(String shellPath, String cwd, String[] args, String[] env, Integer transcriptRows, TerminalSessionClient client) {
        ...
        this.mClient = client;
        this.mExternalSession = false;
        this.mExternalOutput = null;
    }

    public TerminalSession(TerminalSessionClient client, Integer transcriptRows, TerminalSessionOutput externalOutput) {
        this.mShellPath = "";
        this.mCwd = "";
    ...
    public void write(byte[] data, int offset, int count) {
        if (mExternalSession) {
            if (mExternalOutput != null) {
                mExternalOutput.write(data, offset, count);
            }
            return;
        }
    ...
    public void finishExternalSession(int exitStatus) {
        if (!mExternalSession) {
            return;
        }
